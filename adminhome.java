...
public class adminhome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Civil ", "Mechanical", "CSE", "EEE" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into students(course, branch, rollno,name, gender, fathername) values('"+course+"', '"+branch+"','"+rollno+"','"+name+"','"+gender+"','"+fathername+"')");
            ...
            JOptionPane.showMessageDialog(null, "This roll number is already Exists");
            setVisible(false);
            new adminhome().setVisible(true);
        }
